...
def simulate(env, agent):
    ...
    for day in range(30):
        ...
        index_mapping[day] = (
            ...
            format(float(s_demand[highest_index]) + 400, '.2f'),
    ...
    initial_price_list = [env.initial_price for _ in days]

    # Plotting env.initial_price
    plt.figure(figsize=(8, 6))
    plt.plot(days, initial_price_list, marker='o', label='Static Price')
    plt.xlabel('Days')
    plt.ylabel('Price')
    plt.title('Static Price over 30 Days')
    plt.legend()
    ...
    plt.figure(figsize=(8, 6))
    plt.plot(days, prices_as_floats, marker='o', label='Dynamic Price')
    plt.xlabel('Days')
    plt.ylabel('Price')
    ...
    plt.figure(figsize=(8, 6))
    plt.plot(days, dynamic_daily_revenues, marker='o', label='Dynamic Daily Revenue')
    plt.xlabel('Days')
    plt.ylabel('Revenue')
    ...
    # Plotting static_dynamic_revenue
    plt.figure(figsize=(8, 6))
    plt.plot(days, static_daily_revenues, marker='o', label='Static Dynamic Revenue')
    plt.xlabel('Days')
    plt.ylabel('Revenue')
    plt.title('Static Revenue over 30 Days')
    plt.legend()
    plt.gca().xaxis.set_major_locator(ticker.MultipleLocator(5))
    plt.grid(True)
    plt.show()
